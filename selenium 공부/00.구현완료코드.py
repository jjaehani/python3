...
# 로그인 버튼 클릭
lgn = driver.find_element(By.XPATH, '//*[@id="btnlogin"]').click()

# id, pw 입력
driver.find_element(By.ID, 'userId').send_keys('dkdiwaz1234') #id 입력

user_pw = driver.find_element(By.ID, 'userPw')
...
print(result, file=open('결과.txt', 'w', encoding='utf-8'))
